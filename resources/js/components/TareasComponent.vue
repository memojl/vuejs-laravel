...
export default {
  ...
  created(){
    axios.get('/MisSitios/vuejs-laravel/public/notas').then(res=>{
      this.notas = res.data;
    })
  },
  methods:{
    agregar(){
      ...
      axios.post('/MisSitios/vuejs-laravel/public/notas', notaNueva)
        .then((res) =>{
    ...
    editarNota(nota){
      ...
      axios.put(`/MisSitios/vuejs-laravel/public/notas/${nota.id}`, params)
        .then(res=>{
    ...
    eliminarNota(nota, index){
      ...
      if(confirmacion){
        axios.delete(`/MisSitios/vuejs-laravel/public/notas/${nota.id}`)
          .then(()=>{
